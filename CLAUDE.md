...
This repository ships eight process skills under `skills/` (pilot, grilling, grill-with-docs, orchestrate, handoff, diagnosing-bugs, domain-modeling, setup). If you're here to **use** them, install per README.md.
...
- In-pack skill references (the eight above) must resolve; references to outside skills (maestro, hyperframes, code-review, …) must be phrased as optional specialists with a fallback.
